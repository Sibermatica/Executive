...
public final class StringUtils {
	...
	public enum NewLine {
		MACINTOSH("Macintosh"), MACOS("macOS"), UNIX("Unix"), LINUX("Linux"), WINDOWS("Windows"), MS_DOS("DOS");
		...
		public String getNewLine() {
			return StringUtils.addNewLine(this);
		}

		public String getNewLine(String str) {
			return StringUtils.addNewLine(str, this);
		}
	}
	 ...
	 * */
	public static String addNewLine(String str, NewLine type) {
	 ...
	 * */
	public static byte[] addNewLine(byte[] aByte, NewLine type) {
	 ...
	 * */
	public static char[] addNewLine(char[] aChar, NewLine type) {
	 ...
	 * */
	public static StringBuilder addNewLine(StringBuilder strBuilder, NewLine type) {
	 ...
	 * @return the char array with the new line added
	 * */
	public static String addNewLine(NewLine type) {
		return switch (type) {
			case MACINTOSH, MACOS -> "\r";
			// I don't add Linux and Unix because the default branch have the same line return
			case WINDOWS -> "\r\n";
