...
public class Forms extends JFrame
    ...
    /**
     * Initializes all properties & components associated
     * to the form.
     * */
    ...
    public boolean equals(Object o) {
        ...
        Forms forms = (Forms) o;
        return LOG_EVENTS == forms.LOG_EVENTS && x == forms.x && y == forms.y && Objects.equals(LOG_LEVEL, forms.LOG_LEVEL) && Objects.equals(size, forms.size);
    }

    @Override
    public int hashCode() {
        return Objects.hash(LOG_EVENTS, LOG_LEVEL, x, y, size);
    }

    @Override
    public String toString() {
        return "Forms{" + getTitle() + "} @" + hashCode();
    }
}
